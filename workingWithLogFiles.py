...
if __name__ == "__main__":
  ...
  # terminal command : ./find_error.py ~/data/fishy.log 
  # then enter error contents "CRON ERROR Failed to start"
  # fishy.log file data below
  '''
